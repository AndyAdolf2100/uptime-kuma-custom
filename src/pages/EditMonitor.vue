                ...
                <div class="shadow-box shadow-box-with-fixed-bottom-bar">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="my-3">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <option value="json-result-form">
                                            HTTP(s) - JSON Result Form
                                        </option>
                                    </optgroup>
                            ...
                            <!-- JSON Form -->
                            <div
                                v-if="monitor.type === 'json-result-form'"
                                class="my-3"
                            >
                                <label for="jsonResultForm" class="form-label">
                                    JSON Result Form
                                </label>
                                <textarea
                                    id="jsonResultForm"
                                    v-model="monitor.jsonResultForm"
                                    type="text"
                                    class="form-control"
                                    required
                                />
                                <div class="form-text">
                                    custom JSON result form
                                </div>
                            </div>
                ...
                `
{
    ...
    methods: {
                ...
                this.$root
                    ...
                    .emit("getMonitor", this.$route.params.id, (res) => {
                        if (res.ok) {
                            ...
                            console.log("res.monitor", res.monitor);
        ...
        async submit() {
            ...
            if (this.monitor.jsonResultForm) {
                this.monitor.jsonResultForm = this.monitor.jsonResultForm.trim();
            }
